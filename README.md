...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/BrebesBlackXploit/wabot)
...
git clone https://github.com/BrebesBlackXploit/wabot
cd wabot
npm install
npm update
```
